...
### CLI Usage (❌ Removed in v4.0.0)

> **Removal Notice**: The CLI interface was removed in v4.0.0.
> Please use the Python API instead. See the [migration examples](#python-api-recommended) above or docs/development/CLI_MIGRATION_GUIDE.md for detailed migration guidance.
